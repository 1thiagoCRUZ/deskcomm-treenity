...
export const DICIONARIO: Traducoes = {
  ...
  // Respostas salvas espelhadas no Treenity Bot (migration 0235).
  ...
  "O bot usa as respostas salvas": { es: "El bot usa las respuestas guardadas" },
  ...
  "Respostas no bot desligadas — o bot parou de usar as respostas salvas.": { es: "Respuestas en el bot desactivadas: el bot dejó de usar las respuestas guardadas." },
  "Respostas no bot ligadas — as que têm gatilho já valem na próxima mensagem.": { es: "Respuestas en el bot activadas: las que tienen disparador ya valen en el próximo mensaje." },
  "Respostas salvas no bot": { es: "Respuestas guardadas en el bot" },
  "Salve cada uma de novo em Respostas rápidas para reenviar.": { es: "Guarda cada una de nuevo en Respuestas rápidas para reenviarla." },
  "Salve de novo para reenviar ao bot.": { es: "Guarda de nuevo para reenviarla al bot." },
  "Salvo, mas algumas respostas não chegaram ao bot": { es: "Guardado, pero algunas respuestas no llegaron al bot" },
  "Salvo, mas não chegou ao bot. Salve de novo em instantes para reenviar.": { es: "Guardado, pero no llegó al bot. Guarda de nuevo en unos instantes para reenviarla." },
  ...
  "Uma resposta compartilhada com gatilhos passa a ser enviada pelo bot sozinho, na hora e sem consumir IA, quando o cliente escreve uma das frases. As mesmas respostas continuam no / do Inbox para a equipe.": { es: "Una respuesta compartida con disparadores pasa a ser enviada por el bot solo, al instante y sin consumir IA, cuando el cliente escribe una de las frases. Las mismas respuestas siguen en el / del Inbox para el equipo." },
