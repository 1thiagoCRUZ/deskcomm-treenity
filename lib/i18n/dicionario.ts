...
export const DICIONARIO: Traducoes = {
  ...
  // Respostas rápidas guardadas no Treenity Bot (um cadastro para a equipe e o bot).
  "(a mensagem aparece aqui)": { es: "(el mensaje aparece aquí)" },
  "A mesma resposta serve à equipe, pelo / do Inbox, e ao bot, quando tem gatilhos.": { es: "La misma respuesta sirve al equipo, con / en el Inbox, y al bot, cuando tiene disparadores." },
  "A resposta sai na hora, sem usar IA, se a mensagem do cliente contiver um gatilho e couber no tamanho máximo.": { es: "La respuesta sale al instante, sin usar IA, si el mensaje del cliente contiene un disparador y cabe en el tamaño máximo." },
  "Atalho": { es: "Atajo" },
  "Atalho do atendente (opcional)": { es: "Atajo del agente (opcional)" },
  "Buscar por título, gatilho ou texto": { es: "Buscar por título, disparador o texto" },
  "Buscar por título ou texto": { es: "Buscar por título o texto" },
  "Buscar resposta": { es: "Buscar respuesta" },
  "Criar resposta": { es: "Crear respuesta" },
  "Cuidado com gatilhos abertos": { es: "Cuidado con los disparadores abiertos" },
  "[cumprimento], tudo certo? Como posso ajudar?": { es: "[cumprimento], ¿todo bien? ¿En qué puedo ayudarte?" },
  "Editar resposta": { es: "Editar respuesta" },
  "Estado": { es: "Estado" },
  "Excluir esta resposta?": { es: "¿Eliminar esta respuesta?" },
  "Excluir resposta": { es: "Eliminar respuesta" },
  "Filtrar respostas": { es: "Filtrar respuestas" },
  "(frase do cliente)": { es: "(frase del cliente)" },
  "Gatilhos do bot": { es: "Disparadores del bot" },
  "Inserir:": { es: "Insertar:" },
  "Mensagem do cliente maior que isso vai para a IA.": { es: "Un mensaje del cliente más largo que esto va a la IA." },
  "Nenhuma resposta encontrada.": { es: "No se encontró ninguna respuesta." },
  "Nenhuma resposta salva ainda.": { es: "Aún no hay respuestas guardadas." },
  "Nova resposta": { es: "Nueva respuesta" },
  "O bot não preenche {{…}}. Troque por [cumprimento] ou escreva o texto sem variáveis.": { es: "El bot no completa {{…}}. Cámbialo por [cumprimento] o escribe el texto sin variables." },
  "O bot também para de usar esta resposta. Essa ação não pode ser desfeita.": { es: "El bot también deja de usar esta respuesta. Esta acción no se puede deshacer." },
  "O que a equipe digita no Inbox para colar este texto.": { es: "Lo que el equipo escribe en el Inbox para pegar este texto." },
  "O que a sua loja fala. A equipe usa digitando / na conversa, e o bot usa sozinho quando a resposta tem gatilhos.": { es: "Lo que dice tu tienda. El equipo la usa escribiendo / en la conversación, y el bot la usa solo cuando la respuesta tiene disparadores." },
  "Os gatilhos são cadastrados em": { es: "Los disparadores se registran en" },
  "Para o bot poder usar esta resposta, compartilhe com a equipe.": { es: "Para que el bot pueda usar esta respuesta, compártela con el equipo." },
  "Qualquer momento": { es: "Cualquier momento" },
  "Resposta": { es: "Respuesta" },
  "Resposta atualizada.": { es: "Respuesta actualizada." },
  "Resposta criada.": { es: "Respuesta creada." },
  "Resposta excluída.": { es: "Respuesta eliminada." },
  "Salvo. O bot já usa esta resposta na próxima mensagem.": { es: "Guardado. El bot ya usa esta respuesta en el próximo mensaje." },
  "Só a sua equipe vê. O cliente nunca lê o título.": { es: "Solo tu equipo lo ve. El cliente nunca lee el título." },
  "Só atendente": { es: "Solo agente" },
  "Só na 1ª mensagem": { es: "Solo en el 1.er mensaje" },
  "só o atendente usa": { es: "solo la usa el agente" },
  "Uma resposta sem gatilhos é só um atalho de digitação para a equipe. Com gatilhos, o bot passa a responder sozinho, sem consumir IA.": { es: "Una respuesta sin disparadores es solo un atajo de escritura para el equipo. Con disparadores, el bot pasa a responder solo, sin consumir IA." },
  "Usos": { es: "Usos" },
  "vira Bom dia, Boa tarde ou Boa noite pelo horário.": { es: "se convierte en Buenos días, Buenas tardes o Buenas noches según la hora." },  "Guardar as respostas rápidas no bot": { es: "Guardar las respuestas rápidas en el bot" },
  "Respostas rápidas no bot": { es: "Respuestas rápidas en el bot" },
  "Um cadastro só para a equipe e para o bot. A equipe usa a resposta pelo / do Inbox, e o bot manda o texto sozinho, na hora e sem consumir IA, quando o cliente escreve um dos gatilhos. Ligado, as respostas passam a ser guardadas no bot, e as que já existiam aqui deixam de aparecer.": { es: "Un solo registro para el equipo y el bot. El equipo usa la respuesta con / en el Inbox, y el bot envía el texto solo, al instante y sin consumir IA, cuando el cliente escribe uno de los disparadores. Activado, las respuestas pasan a guardarse en el bot, y las que ya existían aquí dejan de aparecer." },
  "Respostas rápidas no bot ligadas — a lista agora é a do bot, e as com gatilho já valem na próxima mensagem.": { es: "Respuestas rápidas en el bot activadas: la lista ahora es la del bot, y las que tienen disparador ya valen en el próximo mensaje." },
  "Respostas rápidas no bot desligadas — a lista voltou a ser só da equipe.": { es: "Respuestas rápidas en el bot desactivadas: la lista volvió a ser solo del equipo." },
  "Só manager+ cria resposta da loja.": { es: "Solo manager+ crea respuestas de la tienda." },
  "Só manager+ altera resposta da loja.": { es: "Solo manager+ modifica respuestas de la tienda." },
  "Só manager+ apaga resposta da loja.": { es: "Solo manager+ elimina respuestas de la tienda." },
  "Resposta não encontrada.": { es: "Respuesta no encontrada." },
  "O Treenity Bot não respondeu agora. Tente de novo em instantes.": { es: "El Treenity Bot no respondió ahora. Inténtalo de nuevo en unos instantes." },
};
